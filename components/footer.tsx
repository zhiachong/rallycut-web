...
const socialLinks = [
  ...
  { name: 'Email', href: 'mailto:hello@rallycut.com', icon: Mail },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">RallyCut</span>
            </div>
            <p className="text-zinc-400 text-sm mb-6">
              AI-powered tennis highlights. 4K export. Half the price.
            </p>
